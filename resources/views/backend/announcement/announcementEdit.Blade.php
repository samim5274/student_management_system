        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="dashboard-card">
                    ...
                    <form action="{{url('/announcement-edit-update/'.$data->id)}}" method="GET" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" value="{{$data->title}}" name="txtTitle" id="title" placeholder="Title" required />
                    ...
                    <div class="mb-3">
                        <img src="{{asset('/img/uploads/'.$data->image)}}" alt="Loading..." class="img-fluid" id="image" style="width: 100%; height: 100%; object-fit: cover;" /><hr>
